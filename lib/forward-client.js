  ...
  async flush() {
    ...
    if (this.client !== null && this.flushHandler === null) {
      ...
      if (this.bufferWriteIndex > 0) {
        ...
        logger.debug("No events to buffer, sending a keep-alive OK to remote host");
      ...
      try {
        await new Promise(this.flushHandler.executor.bind(this.flushHandler));
      } catch (e) {
