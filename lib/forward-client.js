...
class ForwardClient {
  /**
   * Remote forwarder host to connect to
   * @type {String}
   */
  #host;
  /**
   * Remote forwarder port to connect to
   * @type {Integer}
   */
  #port;
  /**
   * Client holding socket connection with remote forwarder
   * @type {Socket}
   */
  #client = null;
  /**
  ...
  connect() {
    logger.debug(`Attempting to connect to ${this.#host}:${this.#port}`);
